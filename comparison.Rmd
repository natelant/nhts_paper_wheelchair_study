...
to work".
```{r comparison.table, echo=F, warning=F, message=F}
...
```{r acs, echo=F, message=F, warning=F}

#=======================================================================

# building the ACS distribution
emp_acs <- tibble(
  Variable = c("Employed", "Not in Labor"),
